...
<body>
    <div class="wrapper">
        ...
        <div class="alert alert-danger samuel animated shake" id="sams1">
            ...
            <strong> Error! </strong><?php echo'OPPS something went wrong';?>
        </div>
        <?php    
                          }      
                      }
                        ...
                        <form action="weather_add.php" method="post">
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label>Temp</label>
                                    <input type="number" name="tempa" class="form-control" maxlength="3"
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <button type="submit" name="submit" class="btn btn-success btn-block"><span
                                            class="fa fa-check"></span> Add</button>
                                </div>
                                <div class="col-md-6 form-group">
                                    <button type="reset" class="btn btn-danger btn-block"><span
